        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药品详细介绍" prop="yaopinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinContent" label="药品详细介绍" prop="yaopinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinContent: [
                              { required: true, message: '药品详细介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
