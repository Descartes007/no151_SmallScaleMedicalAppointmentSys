        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生擅长" prop="yishengShanchang">
                       <el-input v-model="ruleForm.yishengShanchang"
                                 placeholder="医生擅长" clearable  :readonly="ro.yishengShanchang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医生详细介绍" prop="yishengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengContent" label="医生详细介绍" prop="yishengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yishengContent: [
                              { required: true, message: '医生详细介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
