    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="yishengLiuyanText">
                        <el-input type="textarea"  :readonly="ro.yishengLiuyanText" v-model="ruleForm.yishengLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengLiuyanText" label="留言内容" prop="yishengLiuyanText">
                            <span v-html="ruleForm.yishengLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.yishengId = true;//医生
                this.ro.huanzheId = true;//患者
                this.ro.yishengLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yishengLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yishengLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
