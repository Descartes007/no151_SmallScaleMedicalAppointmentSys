<template>
    <div style="backgroundImage: url('/xiaoxingzhenliaoyuyuepingtai/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">小型诊疗预约平台注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="患者姓名" class="input" v-if="tableName=='huanzhe'">
                            <el-input v-model="ruleForm.huanzheName" autocomplete="off" placeholder="患者姓名"  />
                        </el-form-item>
                        <el-form-item label="患者手机号" class="input" v-if="tableName=='huanzhe'">
                            <el-input v-model="ruleForm.huanzhePhone" autocomplete="off" placeholder="患者手机号"  />
                        </el-form-item>
                        <el-form-item label="患者身份证号" class="input" v-if="tableName=='huanzhe'">
                            <el-input v-model="ruleForm.huanzheIdNumber" autocomplete="off" placeholder="患者身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='huanzhe'">
                            <el-input v-model="ruleForm.huanzheEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.huanzheName)&& 'huanzhe'==this.tableName){
                                this.$message.error('患者姓名不能为空');
                                return
                            }
                             if('huanzhe' == this.tableName && this.ruleForm.huanzhePhone&&(!this.$validate.isMobile(this.ruleForm.huanzhePhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.huanzheIdNumber)&& 'huanzhe'==this.tableName){
                                this.$message.error('患者身份证号不能为空');
                                return
                            }
                            if('huanzhe' == this.tableName && this.ruleForm.huanzheEmail&&(!this.$validate.isEmail(this.ruleForm.huanzheEmail))){
